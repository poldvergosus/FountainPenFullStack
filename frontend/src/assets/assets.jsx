...
Сделано в Японии.`
  },
  {
    ...
    details: `Карманная ручка серии Kaweco Sport с восхитительно потертым корпусом. Необычная отделка хорошо дополняет винтажный внешний вид ручки.

Винтажная перьевая ручка с массивным восьмигранным колпачком на резьбе. Дизайн серии разработан в 1936 году. Гравированное стальное перо с иридиевым наконечником.

Длина ручки в закрытом состоянии - 10.5 см, в открытом - 13.5 см. Алюминиевый корпуc. К ручке подходят сменные картриджи Kaweco стандарта International (short) и съемный клип к восьмигранным ручкам Kaweco. Синий картридж в комплекте.

В коллекции Kaweco Classic Sport есть ручки, сделанные из пластика (ICE, Chess, Classic), алюминия (AL Sport), карбона (AC Sport) и акриловой смолы (ART Sport).
...
Сделано в Германии.`
  ...
  },
  {
    ...
    details: `Перьевая ручка Platinum Century #3776 с кристально прозрачным корпусом. Декоративные элементы отделки покрыты розовым золотом. Перо ручки сделано из золота (14К) и также покрыто розовым золотом, толщина F (fine).

В колпачке используется новейший механизм Slip and Seal, предотвращающий высыхание чернил. Благодаря герметичному колпачку в ручку можно заправлять пигментные и карбоновые чернила (в обычных ручках без специального колпачка они высыхают и забивают фидер).

Ручка заправляется картриджами стандарта Platinum, также можно использовать конвертор Platinum Con-500. В комплекте к ручке идут - конвертор Platinum Con-500, картридж с карбоновыми чернилами, картридж с пигментными чернилами, инструкция и печать “written using platinum pigment ink”.

Вес ручки - 18.7 гр. Длина ручки в закрытом состоянии - 139.5 мм.
