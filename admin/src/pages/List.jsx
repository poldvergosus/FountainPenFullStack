  ...
  return (
    <>
      ...
      <div className='flex flex-col gap-2'>
        <div className='hidden lg:grid grid-cols-[1fr_1fr_1fr_1fr_1fr_2fr_1fr_1fr_1fr_1fr_1fr_0.8fr] items-center py-1 px-2 border bg-gray-100 text-sm'>
          <b>Изображение</b>
          <b>Название</b>
          <b>Подзаголовок</b>
          <b>Цена</b>
        ...
        {list.map((item, index) => (
          <div 
            className='grid grid-cols-[1fr_1fr_1fr_1fr_1fr_2fr_1fr_1fr_1fr_1fr_1fr_0.8fr] items-center gap-2 py-1 px-2 border text-sm hover:bg-gray-50 transition' 
            key={index}
          >
